...
setVectorStore('local');

// Usage:
//   npx ts-node src/tests/test-rag-local.ts "your question"
//   npx ts-node src/tests/test-rag-local.ts "your question" rewrite
//   npx ts-node src/tests/test-rag-local.ts "your question" raw
